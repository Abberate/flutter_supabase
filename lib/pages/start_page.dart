                                ...
                                onPressed: () async {
                                  ...
                                  try {
                                    ...
                                    ScaffoldMessenger.of(context)
                                        .showSnackBar(const SnackBar(
                                      content: Text(
                                          'Bravo! email de confirmation envoyer'),
                                      backgroundColor: const Color(0xFF00BF6D),
                                    ));
                                    setState(() {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                        const SnackBar(
                                            content: Text(
                                                'Erreur! email de confirmation non envoyer'),
                                            backgroundColor: Colors.red));
                                    setState(() {
                                      _signUpLoading = false;
                                    });
                            ...
                            _googleSignInLoading
                                ...
                                : SocalCard(
                                    ...
                                    press: () async{
                                      ...
                                      try{
                                        //Syntaxe for google Sign In
                                        await supabase.auth.signInWithOAuth(OAuthProvider.google,redirectTo: kIsWeb ? null : 'io.supabase.myflutterapp://login-callback');
 
                                      }catch(e){
                                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Erreur de connexion"), backgroundColor: Colors.red));
                                        setState(() {
